...
class CreateDotpCustomFieldsStructTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dotp_custom_fields_struct', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dotp_custom_fields_struct');
    }
}
