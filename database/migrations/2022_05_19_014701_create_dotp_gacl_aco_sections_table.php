...
class CreateDotpGaclAcoSectionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dotp_gacl_aco_sections', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dotp_gacl_aco_sections');
    }
}
