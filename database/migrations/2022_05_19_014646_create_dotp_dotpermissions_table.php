...
class CreateDotpDotpermissionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dotp_dotpermissions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dotp_dotpermissions');
    }
}
