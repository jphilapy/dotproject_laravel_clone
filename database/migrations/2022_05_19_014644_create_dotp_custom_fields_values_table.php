...
class CreateDotpCustomFieldsValuesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dotp_custom_fields_values', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dotp_custom_fields_values');
    }
}
