...
VALUES (null, 1, 'TaskStatus', '{"0":"Active","-1":"Inactive"}');
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (null, 1, 'TaskType', '{"0":"Unknown", "1":"Administrative", "2":"Operative"}');
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (null, 1, 'ProjectType', '{"0":"Unknown", "1":"Administrative","2":"Operative"}');
INSERT INTO `sysvals` (`sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (3, 'ProjectColors', '{"Web":"FFE0AE", "Engineering":"AEFFB2", "HelpDesk":"FFFCAE", "System Administration":"FFAEAE"}');
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (null, 1, 'FileType', '{"0":"Unknown", "1":"Document", "2":"Application"}');
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (null, 1, 'TaskPriority', '{"-1":"low", "0":"normal", "1":"high"}');
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (null, 1, 'ProjectPriority', '{"-1":"low", "0":"normal", "1":"high"}');
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (null, 1, 'ProjectPriorityColor', '{"-1":"#E5F7FF", "0":"", "1":"#FFDCB3"}');
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (null, 1, 'TaskLogReference', '{"0":"Not Defined", "1":"Email", "2":"Helpdesk", "3":"Phone Call", "4":"Fax"}');
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
...
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (null, 1, 'TicketPriority', '{"0":"Low", "1":"Normal", "2":"High", "3":"Highest", "4":"911"}');
INSERT INTO `sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (null, 1, 'TicketStatus', '{"0":"Open", "1":"Closed", "2":"Deleted"}');
